...
def load_nyc_taxi(conn, limit=None, graphql_port=8000):
    ...
    try:
        ...
        print_colored(Colors.YELLOW, "Make sure GraphQL server is running on port {}".format(graphql_port))
        return False
    ...
    for parquet_file in parquet_files:
        ...
        try:
            ...
            for batch_idx in range(num_batches):
                ...
                insert_sql = f"INSERT INTO taxi_trips (id, pickup_datetime, dropoff_datetime, passenger_count, " \
