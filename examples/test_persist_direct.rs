// This test directly accesses internal segment APIs to test index persistence
// It bypasses the public Partition API to test Segment.freeze() and Segment.load_frozen()
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let schema = Arc::new(Schema {
        ...
        persist_policy: schema::PersistPolicy::default(),
        primary_key: None,
        store_source: false,
    });
    ...
    let batch = RecordBatch::try_new(arrow_schema, vec![id_array, name_array])?;
